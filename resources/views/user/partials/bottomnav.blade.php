<div class="fixed z-50 w-full h-20 max-w-2xl -translate-x-1/2 backdrop-blur-2xl bg-white/30 border border-white/20 rounded-full bottom-0 left-1/2">
    <div class="grid h-full lg:max-w-xl md:max-w-lg grid-cols-5 mx-auto">
        ...
        <button data-tooltip-target="tooltip-home" type="button" class="inline-flex flex-col items-center justify-center px-5 rounded-s-full hover:bg-gray-100/30 group">
            <svg class="w-8 h-8 mb-1 text-gray-700 group-hover:text-blue-600" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 20 20">
        ...
        <button data-tooltip-target="tooltip-wallet" type="button" class="inline-flex flex-col items-center justify-center px-5 hover:bg-gray-100/30 group">
            <svg class="w-8 h-8 mb-1 text-gray-700 group-hover:text-blue-600" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 20 20">
        ...
        <button data-tooltip-target="tooltip-settings" type="button" class="inline-flex flex-col items-center justify-center px-5 hover:bg-gray-100/30 group">
            <svg class="w-8 h-8 mb-1 text-gray-700 group-hover:text-blue-600" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 20 20">
        ...
        <button data-tooltip-target="tooltip-profile" type="button" class="inline-flex flex-col items-center justify-center px-5 rounded-e-full hover:bg-gray-100/30 group">
            <svg class="w-8 h-8 mb-1 text-gray-700 group-hover:text-blue-600" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 20 20">
