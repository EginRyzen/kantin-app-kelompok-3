...
@section('content')
    ...
    <!-- 
      PENTING: 
      1. method="POST"
      2. action="..." ke route 'store'
      3. @csrf untuk keamanan Laravel
      4. enctype="multipart/form-data" WAJIB untuk upload gambar
    -->
    <form action="{{ route('kasir.products.store') }}" method="POST" enctype="multipart/form-data" class="space-y-5 pb-4">
        ...
        <!-- Diasumsikan ID outlet diambil dari user yang sedang login -->
        ...
        <div>
            ...
            <!-- (Tambahkan script untuk preview gambar di sini jika perlu) -->
        </div>
        ...
        <!-- Kategori & Supplier (Side by side) -->
        ...
        <div class="grid grid-cols-2 gap-5">
            ...
            <!-- Stok Awal -->
            <div>
                <label for="stok" class="block mb-2 text-sm font-medium text-gray-700">Stok Awal <span class="text-red-500">*</span></label>
        ...
        <div class="grid grid-cols-2 gap-5">
            <!-- Tipe Diskon -->
            <div>
                <label for="diskon-tipe" class="block mb-2 text-sm font-medium text-gray-700">Tipe Diskon</label>
                <select id="diskon-tipe" name="diskon-tipe"
                    class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-green-500 focus:border-green-500 block w-full p-3">
