    ...
    <div class="container mx-auto max-w-4xl">
        ...
        <div class="flex items-center justify-between mb-8">
            <div>
                ...
                <p class="text-sm text-gray-500 mt-1">Kelola data master toko dan riwayat stok Anda di sini.</p>
            </div>
            {{-- Ikon Dekorasi --}}
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-5">
            ...
            {{-- 3. MENU SUPPLIER --}}
            <a href="{{ route('kasir.suppliers.index') }}" class="group bg-white p-6 rounded-2xl shadow-sm border border-gray-100 hover:shadow-lg hover:border-orange-200 hover:-translate-y-1 transition-all duration-300 cursor-pointer flex items-start gap-5">
            ...
            {{-- 5. MENU MOVEMENT PRODUK (STOCK MOVEMENT) --}}
            {{-- PERBAIKAN: href sudah diarahkan ke route yang benar --}}
            <a href="{{ route('kasir.stock-movements.index') }}" class="group bg-white p-6 rounded-2xl shadow-sm border border-gray-100 hover:shadow-lg hover:border-indigo-200 hover:-translate-y-1 transition-all duration-300 cursor-pointer flex items-start gap-5 md:col-span-2">
                <div class="w-14 h-14 rounded-2xl bg-indigo-50 text-indigo-600 flex items-center justify-center text-2xl group-hover:bg-indigo-600 group-hover:text-white transition-colors duration-300 shrink-0">
                    <i class="fa-solid fa-arrow-right-arrow-left"></i>
                </div>
                <div class="flex-1">
                    <h3 class="text-lg font-bold text-gray-800 group-hover:text-indigo-700 transition-colors">Movement Produk</h3>
                    <p class="text-sm text-gray-500 mt-1 leading-relaxed">
                        Riwayat keluar masuk stok barang (Stock In/Out Logs).
                    </p>
                    <span class="inline-flex items-center gap-1 mt-3 text-xs font-bold text-indigo-600 bg-indigo-50 px-3 py-1 rounded-full">
                        Lihat Riwayat Stok <i class="fa-solid fa-arrow-right text-[10px]"></i>
                    </span>
                </div>
            </a>
