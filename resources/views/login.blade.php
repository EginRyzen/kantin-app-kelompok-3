...
<body
    class="bg-gradient-to-br from-green-50 via-emerald-100 to-green-200 flex items-center justify-center min-h-screen py-24 px-6">

    <div
        class="w-full max-w-md bg-white/95 backdrop-blur-lg rounded-3xl shadow-2xl glow p-12 border border-green-200 transition-all duration-300 hover:shadow-green-300/60 hover:scale-[1.02]">

        <!-- Gambar di atas -->
        <div class="flex justify-center mb-6">
            <img src="https://cdn-icons-png.flaticon.com/512/857/857681.png" alt="Food Icon"
